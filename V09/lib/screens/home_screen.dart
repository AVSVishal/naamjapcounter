...
class HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    AnalyticsService().startScreenTime('home_screen');
  }
                  ...
                  Expanded(
                    child: _CountryCard(
                      ...
                      onTap: () {
                        ...
                        AnalyticsService().logCountrySelected(
                          Country.india.label,
                          'IN',
                ...
                itemBuilder: (context, index) {
                  ...
                  return _BudgetCard(
                    ...
                    onTap: () {
                      ...
                      final budget = budgets[index];
                      AnalyticsService().logBudgetSelected(
                        budget.amount,
                        provider.country == Country.india ? 'IN' : 'US',
                      );
                      ...
                      ? () {
                          ...
                          AnalyticsService().logButtonClick(
                            ...
                            parameters: {
                              ...
                              'country': provider.country == Country.india ? 'IN' : 'US',
                            },
                          );
                          
                          // Subscribe to push notification topics based on selection
                          NotificationService().subscribeToUserTopics(
                            country: provider.country == Country.india ? 'IN' : 'US',
                            adsEnabled: true, // Default, will be updated later
                            budget: budget.label,
                          );
