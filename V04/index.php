...
.progress-circle{width:clamp(180px,50vw,240px);height:clamp(180px,50vw,240px);margin:0.5rem auto;position:relative}
...
.count-display{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-size:clamp(2.5rem,10vw,4rem);font-weight:700;color:#333;font-variant-numeric:tabular-nums;letter-spacing:-0.05em;line-height:1;transition:transform .1s}
...
.btn-count{width:clamp(120px,30vw,160px);height:clamp(120px,30vw,160px);min-width:44px;min-height:44px;border-radius:50%;border:none;background:linear-gradient(135deg,#ff6b35,#f7931e);color:#fff;font-size:clamp(1.1rem,4.5vw,1.5rem);font-weight:700;cursor:pointer;box-shadow:0 10px 30px rgba(255,107,53,.4);transition:transform .1s,box-shadow .1s;touch-action:manipulation;margin:0.5rem auto;display:flex;align-items:center;justify-content:center}
...
.counter-card-img{width:100%;height:180px;background:linear-gradient(135deg,#667eea,#764ba2);display:flex;align-items:center;justify-content:center;font-size:4rem;color:#fff}
.counter-card-content{padding:1.5rem}
.counter-card h3{color:#333;margin-bottom:.5rem;font-size:1.3rem}
.counter-card p{color:#666;font-size:.95rem;line-height:1.6;margin:0}
@media(max-width:768px){.counter-grid{grid-template-columns:1fr;gap:1rem}}
...
.stats{gap:.4rem}
.progress-circle{width:160px;height:160px}
.count-display{font-size:2rem}
.btn-count{width:110px;height:110px;font-size:1rem;margin:0.3rem auto}
.beads-container{display:none}
.timer{font-size:0.9rem;margin-bottom:0.5rem}
...
<h2 id="mantra-counters">Specific Mantra Counters</h2>
<p>We've created dedicated pages for popular mantras with meanings, benefits, and pronunciation guides:</p>

<div class="counter-grid">
<a href="/gayatri-mantra-counter.php" class="counter-card">
<div class="counter-card-img">☀️</div>
<div class="counter-card-content">
<h3>Gayatri Mantra Counter</h3>
<p>Ancient Vedic mantra for wisdom and enlightenment. Perfect for morning practice.</p>
</div>
</a>
...
<div class="counter-card-content">
<h3>Hare Krishna Mantra Counter</h3>
<p>Maha mantra for Krishna consciousness. Track your 108 mala rounds.</p>
</div>
</a>
...
<div class="counter-card-img">🔱</div>
<div class="counter-card-content">
<h3>Om Namah Shivaya Counter</h3>
<p>Powerful Shiva mantra for transformation and spiritual growth.</p>
</div>
</a>

<a href="/hanuman-chalisa-counter.php" class="counter-card">
<div class="counter-card-img">⚡</div>
<div class="counter-card-content">
<h3>Hanuman Chalisa Counter</h3>
<p>40-verse prayer to Lord Hanuman. Count your daily recitations.</p>
</div>
</a>

<a href="/maha-mrityunjaya-mantra-counter.php" class="counter-card">
<div class="counter-card-img">🕉️</div>
<div class="counter-card-content">
<h3>Maha Mrityunjaya Counter</h3>
<p>Healing mantra for health, longevity, and overcoming obstacles.</p>
</div>
</a>
</div>

<p style="text-align:center;margin-top:2rem;font-size:1.05rem">All counters feature 108 mala tracking, offline support, and progress visualization. Choose your mantra and start counting!</p>
