...
.header{background:#fff;box-shadow:0 2px 10px rgba(0,0,0,.1);position:sticky;top:0;z-index:100;padding:1rem 0}
...
.btn-count{width:clamp(160px,40vw,200px);height:clamp(160px,40vw,200px);border-radius:50%;border:none;background:linear-gradient(135deg,#ff6b35,#f7931e);color:#fff;font-size:clamp(1.5rem,5vw,2rem);font-weight:700;cursor:pointer;box-shadow:0 10px 30px rgba(255,107,53,.4);transition:transform .1s,box-shadow .1s;touch-action:manipulation;margin:1rem auto;display:flex;align-items:center;justify-content:center}
...
.stat{background:#f8f9fa;padding:1rem;border-radius:12px}
...
<a href="/gayatri-mantra-counter/" class="counter-card">
...
<a href="/hare-krishna-mantra-counter/" class="counter-card">
...
<a href="/om-namah-shivaya-counter/" class="counter-card">
<div class="counter-card-img">🔱</div>
<div class="counter-card-content">
...
<a href="#tool" class="btn" style="background:#fff;color:#667eea;padding:1rem 2rem;font-size:1.1rem;display:inline-block;margin-top:1rem;text-decoration:none;border-radius:12px;font-weight:600">Start Counting Now</a>
</section>
